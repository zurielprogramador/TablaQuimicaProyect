 ...
 * @author Zuriel PC
 */
public class Yb extends javax.swing.JFrame {
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Símbolo: Yb");

        jLabel1.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel1.setText("Estado de agregación: Sólido");

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel3.setText("Configuración electrónica: [Xe] 4f146s2     ");

        jLabel8.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel8.setText("Electronegatividad: 1.1");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 173.04");
        ...
        jLabel4.setText("Número Atómico: 70");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Iterbio.jpg"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Iterbio");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El iterbio es un elemento blando y \n"
                + "plateado, una tierra rara de la serie de los \n"
                + "lantánidos y se encuentra en los minerales \n"
                + "gadolinita, monacita y xenotima. El elemento \n"
                + "es a veces asociado con el itrio u otros \n"
                + "elementos relacionados y se usa en ciertos \n"
                + "aceros. El iterbio natural es una mezcla de \n"
                + "siete isótopos estables.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Yb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
