...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Configuración electrónica: [Kr]5s2  ");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Sr");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/estroncio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El estroncio puro es un metal duro\n"
                + "de color blanco, aunque esta forma generalmente\n"
                + "no se encuentra en el ambiente. El estroncio se\n"
                + "encuentra en el ambiente generalmente en forma\n"
                + "de minerales. El estroncio puede formar una \n"
                + "variedad de compuestos. Los compuestos de \n"
