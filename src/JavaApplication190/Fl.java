 ...
 * @author Zuriel PC
 */
public class Fl extends javax.swing.JFrame {
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Configuración electrónica: [Rn]5f146d107s27p2    ");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Ferovio");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 114");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 285");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Ferovio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("Flerovio es el nombre de un elemento \n"
                + "químico radiactivo con el símbolo Fl y número \n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
