 ...
 * @author Zuriel PC
 */
public class Sg extends javax.swing.JFrame {
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Elemento: Seaborgio");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 106");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 263");

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel3.setText("Configuración electrónica: [Rn]5f146d37s2      ");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/seaborgio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El seaborgio es un elemento químico de \n"
                + "la tabla periódica cuyo símbolo es Sg y su número \n"
                + "atómico es 106. Es un elemento sintético cuyo \n"
                + "isótopo más estable es el 271Sg que tiene una \n"
                + "vida media de 2,4 minutos. Su naturaleza química \n"
                + "es similar a la del wolframio.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
