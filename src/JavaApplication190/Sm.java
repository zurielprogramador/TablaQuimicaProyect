...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Samario.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El samario es un elemento químico de \n"
                + "símbolo Sm y número atómico 62. Presenta \n"
                + "una estructura cristalina romboedral, \n"
                + "una masa atómica de 150,35 y una densidad \n"
                + "de 7,35 g/cm³.");
