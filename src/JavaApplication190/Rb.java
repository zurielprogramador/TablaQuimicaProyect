...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Número Atómico: 37");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 85.47");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Rb");

        jLabel8.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel8.setText("Electronegatividad: 0.8");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/rubidio.jpg"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Rubidio");
        ...
        jLabel3.setText("Configuración electrónica: [Kr]5s1");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El rubidio es un metal alcalino,\n"
                + "reactivo, ligero y de bajo punto de fusión.\n"
                + "La mayor parte de los usos de rubidio metálico\n"
                + "y de sus compuestos son los mismos que los del\n"
                + "cesio y sus compuestos. El metal se utiliza en\n"
                + "la manufactura de tubos de electrones, y las\n"
                + "sales en la producción de vidrio y cerámica.");
