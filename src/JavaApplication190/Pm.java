...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/prometio.jpg"))); // NOI18N
        ...
        jLabel9.setText("Elemento: Promecio");

        jLabel10.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel10.setText("Valencia: 3");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 61");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Pm");

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel3.setText("Configuración electrónica: [Xe]4f55d06s2");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 147");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El prometio es un elemento químico \n"
                + "de la tabla periódica cuyo símbolo es Pm \n"
                + "y su número atómico es 61. Algún tiempo\n"
                + "se le denominó ilinio. Se utiliza principalmente\n"
                + "en la investigación con trazadores. Su principal \n"
                + "aplicación la encontramos en la industria del\n"
                + "fósforo. También se usa en la manufactura \n"
                + "de calibradores de aberturas y en baterías \n"
                + "nucleares empleadas en aplicaciones espaciales.\n"
                + "La existencia del prometio fue predicha\n"
                + "por Branner en 1902.");
