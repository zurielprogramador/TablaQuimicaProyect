...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Bohrio.jpg"))); // NOI18N
        ...
        jLabel5.setText("Símbolo: Bh");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Bohrio");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 107");

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel3.setText("Configuración electrónica: [Rn]5f146d57s2      ");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El bohrio es un elemento químico de \n"
                + "la tabla periódica cuyo símbolo es Bh y su \n"
                + "número atómico es 107. Su nombre le fue dado \n"
                + "en honor al científico danés Niels Bohr. \n"
                + "Elemento químico que se espera que tenga \n"
