...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Símbolo: Kr");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 83.80");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 36");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/kripton.jpg"))); // NOI18N
        ...
        jLabel3.setText("Configuración electrónica: [Ar]3d104s24p6    ");
        ...
        jLabel9.setText("Elemento: Kriptón");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El kriptón es un elemento \n"
                + "químico de la tabla periódica cuyo símbolo es \n"
                + "Kr y su número atómico es 36.Es un gas noble \n"
                + "incoloro, inodoro e insípido que se encuentra \n"
                + "en cantidades mínimas en la atmósfera y este a \n"
                + "menudo se utiliza con otros gases raros en \n"
