...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Número Atómico: 68");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Erbio.jpg"))); // NOI18N
        ...
        jLabel9.setText("Elemento: Erbio");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El erbio es un elemento químico de la \n"
                ...
                + "raro de color plateado perteneciente a los \n"
                + "lantánidos y que aparece asociado a otros \n"
                + "lantánidos en el mineral gadolinita procedente \n"
                + "de Ytterby.");
