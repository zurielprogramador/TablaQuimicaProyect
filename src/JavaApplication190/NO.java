...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Nobelio.jpg"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel3.setText("Configuración electrónica: [Rn]5f147s2   ");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 102");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: No");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Nobelio");
        ...
        jLabel7.setText("Masa atómica: 259");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El nobelio es un elemento sintético \n"
                + "de la tabla periódica cuyo símbolo es No \n"
                + "y su número atómico es 102, llamado así \n"
                + "en honor del inventor Alfred Nobel. Es el \n"
                + "11.er elemento sintético de la tabla\n"
                + "periódica. Su decaimiento se realiza por \n"
                + "emisión de partículas alfa, es decir, un \n"
                + "ion de helio doblemente cargado.");
