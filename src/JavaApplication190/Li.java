...
public class Li extends javax.swing.JFrame {
 imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/litio.jpg"))); // NOI18N
        ...
        jLabel3.setText("Configuración electrónica: 1s2 2s1");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 3");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Li");

        jLabel6.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel6.setText("Estado de oxidación: +1");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 6.941");
        ...
        jLabel9.setText("Elemento: Litio");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El litio encabeza la familia de\n"
                ...
                + "periódica en la naturaleza se encuentra\n"
                + "En la naturaleza se encuentra como una mezcla\n"
                + "de los isótopos Li6 y Li7. Es el metal sólido\n"
                + "más ligero, es blando, de bajo punto de fusión\n"
                + "y reactivo. Muchas propiedades físicas y \n"
                + "químicas son tan o más parecidas a las de los \n"
