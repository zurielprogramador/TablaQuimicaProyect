...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Fosforo.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText(" El fósforo es un mineral que se \n"
                + "encuentra en cada un de las células de nuestro \n"
                + "organismo. La mayor parte del fósforo está en \n"
                + "los huesos y los dientes, y otra parte en los \n"
                + "genes. El organismo necesita fósforo para \n"
                + "producir energía y llevar a cabo muchos \n"
