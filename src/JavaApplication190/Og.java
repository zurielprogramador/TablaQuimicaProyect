...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/oganeson.jpg"))); // NOI18N
        ...
        jLabel3.setText("Configuración electrónica: [Rn]5f146d107s27p6       ");
        ...
        jLabel5.setText("Símbolo: Og");

        jLabel8.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel8.setText("Electronegatividad: -");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Oganesón");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 294");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 118");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El oganesón es el nombre para el \n"
                + "elemento sintético de la tabla periódica \n"
                + "cuyo símbolo es Og y su número atómico es \n"
                + "118. Es el elemento más pesado sintetizado \n"
                + "hasta ahora y el último del séptimo período \n"
                + "en la tabla periódica. En la tabla periódica \n"
                + "es un elemento del bloque p y el último del \n"
                + "periodo 7.");
