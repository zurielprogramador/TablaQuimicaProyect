...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Configuración electrónica: [Ne]3s2  ");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Mg");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Magnesio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El magnesio es el elemento químico de\n"
                ...
                + "es de 24,305 u. Es el octavo elemento en \n"
                + "abundancia en el orden del % de la corteza \n"
                + "terrestre y el tercero más abundante disuelto\n"
                + "en el agua de mar. El ion de magnesio es \n"
