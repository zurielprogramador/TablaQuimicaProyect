...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Número Atómico: 21");
        ...
        jLabel3.setText("Configuración electrónica: [Ar]3d14s2    ");

        jLabel6.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel6.setText("Estado de oxidación: +3");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Escandio");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 44.956");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Escandio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El escandio es un elemento químico \n"
                + "de la tabla periódica cuyo símbolo es Sc y \n"
                + "su número atómico es 21. Es un metal de \n"
                + "transición que se encuentra en minerales \n"
                + "de Escandinavia y que se clasifica con \n"
                + "frecuencia entre los lantánidos por sus \n"
