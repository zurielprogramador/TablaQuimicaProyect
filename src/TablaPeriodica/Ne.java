...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Símbolo: Ne");

        jLabel8.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel8.setText("Electronegatividad: -");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 20.179");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/neon.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El neón es un elemento químico de \n"
                + "número atómico 10 y símbolo Ne. Es un gas \n"
                + "noble, incoloro, prácticamente inerte, \n"
                + "presente en trazas en el aire, pero muy \n"
                + "abundante en el universo, que proporciona \n"
                + "un tono rojizo característico a la luz de \n"
