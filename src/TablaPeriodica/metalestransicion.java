 ...
 * @author Zuriel PC
 */
public class metalestransicion extends javax.swing.JFrame {

    /**
     * Creates new form metalestransicion
     */
    public metalestransicion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 350, 130, 130));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 480));
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        // TODO add your handling code here:
        jTextArea1.setText("A los metales de transición se los \n"
                + "llama así porque son estables a nivel orbital, \n"
                + "ya que cuando faltan electrones en un orbital, \n"
                + "los pueden tomar del otro sin que esta \n"
                + "transición implique inestabilidades a nivel \n"
                + "atómico o químico. Esto se le llama Transición \n"
                + "Electrónica, y hace que estos elementos tengan \n"
                + "tanta estabilidad, haciendo que sea complicado \n"
                + "que reaccionen con otros elementos.\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(metalestransicion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new metalestransicion().setVisible(true);
            }
        });
    }
