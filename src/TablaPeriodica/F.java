...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Elemento: Flúor");

        jLabel8.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel8.setText("Electronegatividad: 4");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 18.9984");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 9");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Fluor.jpg"))); // NOI18N
        ...
        jLabel3.setText("Configuración electrónica: 1s22s22p5  ");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El flúor es el elemento químico de \n"
                ...
                + "halógenos de la tabla periódica de los \n"
                + "elementos. Su símbolo es F.Es un gas a \n"
                + "temperatura ambiente, de color verde pálido, \n"
                + "formado por moléculas diatómicas F2. Es el \n"
                + "más electronegativo y reactivo de todos \n"
                + "los elementos.");
