...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Número Atómico: 99");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Einstenio");

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel3.setText("Configuración electrónica: [Rn]5f117s2    ");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Es");
        ...
        jLabel7.setText("Masa atómica: 254");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/einstenio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El einstenio (Es) es el elemento número \n"
                + "99 de la tabla periódica. Fue descubierto por \n"
                + "primera vez en 1952 cuando un dispositivo \n"
                + "termonuclear denominado \"Ivy Mike\" fue detonado \n"
                + "en la isla de Elugelab en el Océano Pacífico \n"
                + "(ahora parte de las Islas Marshall).");
