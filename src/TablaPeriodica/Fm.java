...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Configuración electrónica: [Rn]5f127s2    ");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Fm");
        ...
        jLabel7.setText("Masa atómica: 257");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Fermio.jpg"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 100");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Fermio");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("Elemento químico, símbolo Fm, número \n"
                + "atómico 100, el undécimo elemento de los \n"
                + "actínidos. El fermio no se encuentra en la \n"
                + "naturaleza; su descubrimiento y producción se\n"
                + "alcanza por transmutación nuclear artificial de \n"
                + "lementos más ligeros. Se han descubierto los \n"
                + "isótopos radiactivos de número de masa 244-259.");
