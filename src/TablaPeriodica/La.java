...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Lantano.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El lantano se usa para reducir los\n"
                + "niveles de fosfato en la sangre en las personas\n"
                + "con enfermedad renal. Altos niveles de fosfato \n"
                + "en la sangre pueden ocasionar problemas en \n"
                + "los huesos. El lantano pertenece a una clase de\n"
