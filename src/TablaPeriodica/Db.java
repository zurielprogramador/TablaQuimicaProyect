...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Masa atomica: 262");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/dubnio.jpg"))); // NOI18N
        ...
        jLabel5.setText("Símbolo: Db");

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Dubnio");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 105");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El dubnio es un elemento químico de \n"
                + "la tabla periódica de los elementos cuyo \n"
                + "símbolo es Db y su número atómico 105. El \n"
                + "elemento fue nombrado en honor a la ciudad \n"
                + "de Dubná, Rusia, sede del Instituto Central \n"
                + "de Investigaciones Nucleares, donde fue \n"
