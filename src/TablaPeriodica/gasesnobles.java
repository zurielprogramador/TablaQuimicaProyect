...
public class gasesnobles extends javax.swing.JFrame {
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        // TODO add your handling code here:
        jTextArea1.setText("Los gases nobles son un conjunto de \n"
                + "elementos químicos que comparten un rango \n"
                + "determinado de características: \n"
                + "son monoatómicos, inodoros e incoloros en \n"
                + "condiciones normales, tienen puntos de \n"
                + "ebullición muy bajos y solo pueden licuarse \n"
                + "bajo grandes presiones. Por ejemplo: neón, \n"
                + "xenón, radón. Los gases nobles, sobre todo, \n"
                + "presentan una muy baja reactividad química, \n"
                + "es decir, poca combinabilidad con otros \n"
                + "elementos de la tabla periódica. Por esa \n"
                + "razón han recibido también el nombre de \n"
                + "gases inertes o gases raros, aunque ambos \n"
                + "nombres se desaconsejan hoy en día.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gasesnobles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
