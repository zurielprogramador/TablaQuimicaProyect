...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Número Atómico: 87");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/fransio2.jpg"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel9.setText("Elemento: Francio");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El francio es un elemento químico cuyo\n"
                + "símbolo es Fr y su número atómico es 87.\n"
                + "Su electronegatividad es la más baja conocida\n"
                + "y es el segundo elemento menos abundante en la\n"
