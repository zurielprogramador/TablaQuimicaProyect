...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Elemento: Titanio");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 47.90");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Titanio.jpg"))); // NOI18N
        ...
        jLabel5.setText("Símbolo: Ti");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 22");
        ...
        jLabel3.setText("Configuración electrónica: [Ar]3d24s2      ");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El titanio es un elemento químico de \n"
                + "símbolo Ti y número atómico 22 que se sitúa \n"
                + "en el grupo 4 de la tabla periódica de los \n"
                + "elementos. Es un metal de transición de color \n"
                + "gris, baja densidad y gran dureza. Es muy \n"
                + "resistente a la corrosión por agua del mar, \n"
                + "agua regia y cloro.");
