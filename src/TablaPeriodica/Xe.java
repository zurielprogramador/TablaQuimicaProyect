...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Símbolo: Xe");

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel7.setText("Masa atómica: 12.21");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel4.setText("Número Atómico: 54");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/xenon.jpg"))); // NOI18N
        ...
        jLabel3.setText("Configuración electrónica: [Kr]4d105s25p6      ");
        ...
        jLabel9.setText("Elemento: Xenón");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El xenón es un elemento químico de \n"
                + "la tabla periódica cuyo símbolo es Xe y su \n"
                + "número atómico el 54. Gas noble inodoro, muy \n"
                + "pesado, incoloro, el xenón está presente en \n"
                + "la atmósfera terrestre solo en trazas y fue \n"
                + "parte del primer compuesto de gas noble \n"
                + "sintetizado.");
