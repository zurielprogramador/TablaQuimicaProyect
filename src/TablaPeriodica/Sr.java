...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel37.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesElementos/estroncio.jpg"))); // NOI18N
        ...
        jLabel20.setText("[Kr]5s2  ");

        jLabel28.setText("Sólido");

        jLabel32.setText("768");
        ...
        jLabel31.setText("1380");

        jLabel21.setText("A. Crawford en 1790");

        jLabel29.setText("2.6");

        jLabel12.setText("Estroncio");

        jLabel33.setText("5.73");

        jLabel23.setText("DENSIDAD (g/ml):");

        jLabel10.setText("CONFIGURACIÓN ELECTRÓNICA:");

        jLabel13.setText("87.62");
