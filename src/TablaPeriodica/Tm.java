...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Número Atómico: 69");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/tulio.jpg"))); // NOI18N
        ...
        jLabel9.setText("Elemento: Tulio");
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("Elemento químico de símbolo Tm, con \n"
                + "número atómico 69 y peso atómico 168.934. \n"
                + "Es un elemento metálico poco común que \n"
                + "pertenece al grupo de las tierras raras. \n"
                + "El isótopo estable 169Tm constituye el 100% \n"
                + "del elemento que se encuentra en la naturaleza.");
