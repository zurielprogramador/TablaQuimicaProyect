...
public class metaloides extends javax.swing.JFrame {
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        // TODO add your handling code here:
        jTextArea1.setText("Una serie de seis elementos llamados \n"
                + "metaloides separa los metales de los no metales \n"
                + "en la tabla periódica. Los metaloides son el \n"
                + "boro, el polonio, el silicio, el germanio, el \n"
                + "arsénico, el antimonio y el telurio. Estos \n"
                + "elementos parecen metálicos; sin embargo, \n"
                + "no conducen la electricidad tan bien como \n"
                + "los metales, por lo que son semiconductores. \n"
                + "Son semiconductores porque sus electrones \n"
                + "están más unidos a sus núcleos que los de \n"
                + "los conductores metálicos. Su comportamiento \n"
                + "químico se sitúa entre el de los metales y \n"
                + "el de los no metales.");
