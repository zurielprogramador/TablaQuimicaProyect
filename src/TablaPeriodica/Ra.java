...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Configuración electrónica: [Rn]7s2");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel5.setText("Símbolo: Ra");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Radio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El radio es un metal radiactivo \n"
                + "blanco-plateado que ocurre naturalmente y \n"
                + "que puede existir en varias formas llamadas\n"
                + "isótopos. El radio es formado cuando el uranio \n"
                + "y el torio se degradan en el ambiente. El uranio\n"
                + "y el torio se encuentran en pequeñas cantidades\n"
                + "en la mayoría de las rocas y en el suelo.");
