...
public class lantanidos extends javax.swing.JFrame {
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        // TODO add your handling code here:
        jTextArea1.setText("Los lantánidos se encuentran en \n"
                + "muchos minerales, principalmente en la monazita.\n"
                + "En rocas ígneas sobre la superficie de la tierra, \n"
                + "el cerio es el elemento más abundante de ellos. \n"
                + "Los lantánidos puros son metales plateados con \n"
                + "altos puntos de ebullición. Reaccionan \n"
                + "lentamente con el aire, excepto el Samario, \n"
                + "el Europio, y el Iterbio, que son mucho mas \n"
                + "reactivos con el oxígeno. Los metales son \n"
                + "preparados de floruros u óxidos por un \n"
                + "tratamiento con un fuerte reductor\n"
                + "de metales, como el Calcio, o de sales  \n "
                + "cloruras y floruras por electrólisis a \n"
                + "altas temperaturas.");
