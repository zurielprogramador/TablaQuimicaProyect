...
imagenfondo Imagen=new imagenfondo();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Elemento: Holmio");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TablaPeriodica/Holmio.jpg"))); // NOI18N
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        ...
        jTextArea1.setText("El holmio es un elemento químico de la \n"
                + "tabla periódica cuyo símbolo es Ho y su número \n"
                + "atómico es 67. Es un metal relativamente blando, \n"
                + "plateado, bastante resistente a la corrosión \n"
                + "y maleable.");
