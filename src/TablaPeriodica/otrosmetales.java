...
public class otrosmetales extends javax.swing.JFrame {
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        // TODO add your handling code here:
        jTextArea1.setText("El término se utiliza para referirse a \n"
                + "elementos puros o aleaciones con características \n"
                + "metálicas. Entre las diferencias con los no \n"
                + "metales se pueden mencionar que los metales \n"
                + "tienen una energía de ionización baja y baja \n"
                + "electronegatividad.\n" +
"\n" +
"puede recibir fuerzas repentinas sin\n"
                + " romper, dúctil (se puede moldearlos en \n"
                + "alambres o cables), flexible (convertido \n"
                + "en cuchillas para ser comprimido) y tienen \n"
                + "una buena resistencia mecánica (resistir \n"
                + "esfuerzos de tracción , flexión, torsión \n"
                + "y compresión sin deformar).");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(otrosmetales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
