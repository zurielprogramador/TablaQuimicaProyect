...
public class alcalinoterreos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form alcalinoterreos
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 520, 130, 130));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 650));
    ...
    private void jTextArea1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextArea1PropertyChange
        // TODO add your handling code here:
        jTextArea1.setText("Los metales alcalinotérreos son un \n"
                + "grupo de 6 elementos químicos que conforman \n"
                + "Grupo 2 en la tabla periódica. Se caracterizan\n"
                + "por ser mas duros que los metales alcalinos, \n"
                + "son brillosos y conducen bien la electricidad. \n"
                + "No son tan reactivos como los alcalinos, ya que \n"
                + "poseen 2 electrones en el último orbital, \n"
                + "mientras que aquellos poseen uno solo. Los \n"
                + "metales alcalino térreos se llaman así porque, \n"
                + "al igual que los alcalinos, al reaccionar con \n"
                + "el oxígeno forman óxidos básicos o alcalinos, \n"
                + "pero tienden a ser poco solubles en el agua, \n"
                + "por lo que no se disuelven y queda la tierra. \n"
                + "De hecho, sus óxidos recibían el nombre de \n"
                + "tierras en épocas antiguas.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(alcalinoterreos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
