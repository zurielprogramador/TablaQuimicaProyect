...
public class METALOIDES extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 153, 51)));
        jPanel1.setForeground(new java.awt.Color(255, 255, 102));

        NDEVARIABLE.setFont(new java.awt.Font("Tahoma", 0, 73)); // NOI18N
        NDEVARIABLE.setForeground(new java.awt.Color(0, 153, 51));

        nombre.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        nombre.setForeground(new java.awt.Color(0, 153, 51));

        numero.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        numero.setForeground(new java.awt.Color(0, 153, 51));

        oxi.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        oxi.setForeground(new java.awt.Color(0, 153, 51));

        PESO.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        PESO.setForeground(new java.awt.Color(0, 153, 51));

        CONFIGATOMIC2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        CONFIGATOMIC2.setForeground(new java.awt.Color(0, 153, 51));

        oxi2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        oxi2.setForeground(new java.awt.Color(0, 153, 51));

        CONFIGATOMIC.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        CONFIGATOMIC.setForeground(new java.awt.Color(0, 153, 51));
