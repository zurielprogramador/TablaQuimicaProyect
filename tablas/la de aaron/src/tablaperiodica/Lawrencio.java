...
public class Lawrencio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText(" [Rn] 5f147s27p1");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("Masa Atómica:");

        jLabel12.setText("(262)");

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("El lawrencio o laurencio​ es un elemento \nsintético radiactivo de la tabla periódica \nde los elementos cuyo símbolo es Lr y su\n número atómico es 103. En la tabla\n periódica, se sitúa en el bloque d y en el \nperíodo 7, y es el último elemento y el \nmás pesado de la serie de los actínidos");
        ...
        jLabel17.setText(" 1,627 °C");

        jLabel1.setText("1.1");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/laurencio.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lawrencio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
