...
public class Cadmio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("112.411 u");

        jLabel17.setText("321.1 °C");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/cadmio.png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("Masa Atómica:");

        jLabel15.setText("158 pm");
        ...
        jTextArea1.setText("El cadmio es un elemento químico de \nnúmero atómico 48 situado en el grupo \n12 de la tabla periódica de los elementos.\n Su símbolo es Cd. Es un metal pesado,\n blando, blanco azulado, relativamente \npoco abundante. Es uno de los\n metales más tóxicos.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel11.setText("48");

        jLabel1.setText("1.69");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadmio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
