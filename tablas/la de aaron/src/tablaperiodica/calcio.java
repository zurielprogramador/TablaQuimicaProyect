...
public class calcio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("[Ar]4s");

        jLabel10.setText("Ca");

        jLabel15.setText("1,97");

        jLabel17.setText("1,0");

        jLabel16.setText("2,8,8,2");
        ...
        jTextArea1.setText("El calcio es un elemento quimico,El calcio\nes un metal blando, grisaceo, y es el\nquinto mas abundante en masa de la \ncorteza terrestre. Tambien es el ion mas \nabundante disuelto en el agua de  mar,\ntanto como su molaridad y como por su\nmasa.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("Numero Atómico:");

        jLabel12.setText("40,08");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/calcio.png"))); // NOI18N
