...
public class mendelevio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("2, 8, 18, 32, 31, 8, 2 ");

        jLabel13.setText("[Rn] 5f137s2");

        jLabel12.setText("258 u");

        jLabel17.setText("827 °C");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/mendelevio.png"))); // NOI18N
        ...
        jTextArea1.setText("El mendelevio es un elemento de la tabla\n periódica cuyo símbolo es Md y su \nnúmero atómico es 101​. El nombre de\n este elemento proviene del creador de la\n tabla periódica de los elementos: Dmitri\n Mendeleyev.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mendelevio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mendelevio().setVisible(true);
            }
        });
    }
