...
public class fluor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("[He] 2s22p5");

        jLabel16.setText("2, 8, 18, 32, 32, 18, 6 ");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/fluor.jpg"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel9.setText("Punto De Fusión");

        jLabel12.setText("18.998403 u");
        ...
        jTextArea1.setText("El flúor es el elemento químico de \nnúmero atómico 9 situado en el grupo de \nlos halógenos de la tabla periódica de los\n elementos. Su símbolo es F. Es un gas a\n temperatura ambiente, de color verde\n pálido, formado por moléculas \ndiatómicas F₂. Es el más electronegativo y \nreactivo de todos los elementos.");
