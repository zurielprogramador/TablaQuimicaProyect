...
public class Uranio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/uranio_1.jpg"))); // NOI18N

        jLabel17.setText("1132ºC");

        jLabel16.setText("2,8,18,32,21,9,2");

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("El uranio es un elemento químico metálico\n de color plateado-grisáceo de la serie de \nlos actínidos, su símbolo químico es U y su \nnúmero atómico es 92. Por ello posee 92 \nprotones y 92 electrones, con una valencia\n de 6.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel15.setText("230 pm");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Uranio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
