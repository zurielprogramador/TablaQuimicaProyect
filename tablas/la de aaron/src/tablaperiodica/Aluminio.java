...
public class Aluminio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("El aluminio es un elemento químico, \nde símbolo Al y número atómico 13. \nSe trata de un metal no ferromagnético. \nEs el tercer elemento más común \nencontrado en la corteza terrestre.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel12.setText("26.981539  u");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("Configuración Electronica:");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/Aluminium-4.jpg"))); // NOI18N

        jLabel15.setText("184 pm");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aluminio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
