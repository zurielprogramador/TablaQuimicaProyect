...
public class astato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("[Xe] 4f¹⁴5d¹⁰6s²6p⁵");

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("El astato es un elemento químico de la\n tabla periódica cuyo símbolo es At y su \nnúmero atómico es 85. Es radiactivo y el \nmás pesado de los halógenos. Se\n produce a partir de la degradación de \nuranio y torio");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel16.setText("2, 8, 18, 32, 18, 7");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/astato.jpg"))); // NOI18N
