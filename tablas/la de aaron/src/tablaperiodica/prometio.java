...
public class prometio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/prometio.jpg"))); // NOI18N

        jLabel17.setText("1,042 °C");
        ...
        jTextArea1.setText("El prometio es un elemento químico de la \ntabla periódica cuyo símbolo es Pm y su\n número atómico es 61. Algún tiempo se le\n denominó ilinio");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel15.setText("243 pm");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prometio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
