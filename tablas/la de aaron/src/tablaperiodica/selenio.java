...
public class selenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("El selenio es un elemento químico de \nla tabla periódica cuyo símbolo es Se y\n su número atómico 34. Pertenece a la\n familia de los no metales.");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/selenio2.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(selenio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
