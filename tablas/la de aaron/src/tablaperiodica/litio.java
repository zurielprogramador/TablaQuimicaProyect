...
public class litio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("6.941 u");

        jLabel13.setText("1s²2s¹");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/litio_1.jpg"))); // NOI18N

        jTextArea2.setEditable(false);
        jTextArea2.setColumns(20);
        jTextArea2.setRows(5);
        jTextArea2.setText("El litio ​ es un elemento químico de \nsímbolo Li y número atómico 3. En la\n tabla periódica, se encuentra en el grupo 1,\n entre los elementos alcalinos. En su forma\n pura, es un metal blando, de color blanco \nplata, que se oxida rápidamente en aire o \nagua");
        jScrollPane2.setViewportView(jTextArea2);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("Eletrones por Nivel:");
