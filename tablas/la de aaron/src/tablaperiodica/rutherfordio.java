...
public class rutherfordio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/rutherfordio.jpg"))); // NOI18N

        jLabel16.setText("2, 8, 18, 32, 32, 10, 2");
        ...
        jLabel13.setText("[Rn] 5f146d27s2");
        ...
        jLabel17.setText("2,100 °C");

        jLabel12.setText("(261)");
        ...
        jTextArea1.setText("El rutherfordio ​ es un elemento químico\n de la tabla periódica cuyo símbolo es Rf\n y su número atómico es 104. Su nombre\n fue elegido en honor del Barón Ernest \nRutherford, científico colaborador del\n modelo atómico y física nuclear\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rutherfordio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rutherfordio().setVisible(true);
            }
        });
    }
