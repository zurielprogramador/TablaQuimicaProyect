...
public class Berilio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("9.012182 u");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("Masa Atómica:");

        jLabel13.setText("[He] 2s");

        jLabel15.setText("112 pm");
        ...
        jLabel17.setText("1.57");

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("EL berilio es un elemento quimico de simbolo\nBe y numero atomico 4. Es un elemento \nAlcalinoterreo bivalente, toxico, de color \ngris, duro, ligero, y quebradizo. Se emplea \nprincipalmente como endurecedor en \naleaciones, especialmente de cobre.");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/berilio.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Berilio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
