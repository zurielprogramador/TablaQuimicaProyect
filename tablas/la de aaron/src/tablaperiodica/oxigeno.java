...
public class oxigeno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/oxigeno.jpg"))); // NOI18N
        ...
        jTextArea1.setText("El oxígeno es un elemento químico de\n número atómico 8 y representado por el\n símbolo O. Su nombre proviene de las \nraíces griegas ὀξύς y –γόνος, porque en\n la época en que se le dio esta \ndenominación se creía, incorrectamente, \nque todos los ácidos requerían \noxígeno para su composición.");
