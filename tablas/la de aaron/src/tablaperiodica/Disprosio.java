...
public class Disprosio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("2, 8, 18, 28, 8, 2");
        ...
        jLabel13.setText("[Xe] 4f106s2");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/disprosio.jpg"))); // NOI18N

        jLabel1.setText("1.22");

        jLabel15.setText("235 pm");
        ...
        jTextArea1.setText("El disprosio es un elemento químico cuyo \nsímbolo es Dy y su número atómico es 66.\n Es un metal de transición de color blanco\n plata, incluido en el grupo de los\n lantánidos o tierras raras.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel17.setText("1,412 °C");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Disprosio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
