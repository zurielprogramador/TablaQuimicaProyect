...
public class fermio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("2,8,18,32,30,8,2");
        ...
        jLabel13.setText("[Rn] 5f127s2");

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("El fermio es un elemento químico \nradiactivo creado artificialmente cuyo \nnúmero atómico es 100 y de peso atómico\n 254, de símbolo Fm. Existen 16 isótopos\n conocidos siendo el ²⁵⁷Fm el más estable\n con un periodo de semidesintegración\n de 100,5 días.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/fermio.jpg"))); // NOI18N

        jLabel1.setText("1.3");

        jLabel17.setText("1,527 °C");
