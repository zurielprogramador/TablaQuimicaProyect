 ...
 * @author carid
 */
public class infitrio extends javax.swing.JFrame {

    /**
     * Creates new form infitrio
     */
    public infitrio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("informacion del Itrio");
        jLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 204, 255), 3));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 10, 310, 71));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TABLAPERIODICA1/itrio.jpg"))); // NOI18N
        ...
        jTextArea1.setText("El itrio es un elemento químico de la tabla periódica\n cuyo símbolo es Y y su número atómico es 39.\n Su peso atómico es 88,905. Es una tierra rara de \ntransición del grupo IIIB. Es un metal plateado de \ntransición, común en los minerales de tierras raras.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(infitrio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
