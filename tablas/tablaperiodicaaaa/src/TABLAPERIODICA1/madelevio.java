 ...
 * @author carid
 */
public class madelevio extends javax.swing.JFrame {

    /**
     * Creates new form madelevio
     */
    public madelevio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TABLAPERIODICA1/mandelevio.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 255, 153));
        jLabel2.setText("informacion del Mandelevio");
        ...
        jTextArea3.setText("El mendelevio es un elemento de la tabla\n periódica cuyo símbolo es Md y su número\n atómico es 101​. El nombre de este elemento \nproviene del creador de la tabla \nperiódica de los elementos: Dmitri Mendeleyev.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(madelevio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
