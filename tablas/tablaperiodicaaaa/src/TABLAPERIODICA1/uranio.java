...
public class uranio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("informacion del Uranio");
        ...
        jTextArea3.setText("El uranio es un elemento químico metálico de \ncolor plateado-grisáceo de la serie de los \nactínidos, su símbolo químico es U y su número \natómico es 92. Por ello posee 92 \nprotones y 92 electrones, con una valencia de 6.");
